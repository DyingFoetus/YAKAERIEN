        ...
        <s:if test="logged == true">
            ...
            <div id="center">     
                ...
                <div id="center_content">
                    <button type="button" class="boutton" style="float:left;">Ajouter un avion</button>
                    <button type="button" class="boutton" style="">Exporter en XML</button>
                    <button type="button" class="boutton" style="float:right;">Recherche d'un avion</button>
